  ...
  <div class="articleDetail-container">
    ...
    <div class="content">
      <div class="diary-card">
        ...
        <div class="sub-title">
          ...
          <div class="flex-box">
            ...
            <span>
              {{ dayjs(articleDetail.updatedAt).format('YYYY-MM-DD HH') }}
            </span>
          </div>
        </div>
      ...
      <div class="diary-card">
        ...
        <div v-if="articleDetail.tagArray && articleDetail.tagArray.length" class="tags-content">
          <h4 class="tags-title">相关标签</h4>
          <div class="tag-lists">
            <el-tag v-for="tag in articleDetail.tagArray" :key="tag" class="tag-item" effect="light">
              {{ tag }}
            </el-tag>
          </div>
        </div>
