    ...
    <div class="content">
      ...
      <div class="diary-card">
        ...
        <div class="emotion-grid">
          <div v-for="item in emotionOptions" :key="item.name" class="emotion-card" @click="selectEmotion(item.name)"
            :class="{ 'selected': item.name === diaryForm.emotionOptions }">
            <el-image :src="item.url" style="width: 50px; height: 50px" alt="emotion" />
...
const selectEmotion = (emotion) => {
  diaryForm.emotionOptions = emotion
}
